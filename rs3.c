...
#define BOMBA1   0   // WiringPi pin bomba 1 (Agua)
#define BOMBA2   1   // WiringPi pin bomba 2 (AFS40)
#define VALV1    2   // WiringPi pin válvula 1
#define VALV2    3   // WiringPi pin válvula 2
...
int main() {
    ...
    pullUpDnControl(FLUJO1, PUD_DOWN);
    pullUpDnControl(FLUJO2, PUD_DOWN);
